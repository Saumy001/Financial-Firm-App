...
<ReportingLayout/>
        ...
        <div className="flex-1 overflow-auto">
          ...
          <div className="border-b border-gray-200 px-6 py-4">
            ...
            <div className="mt-1 text-sm text-gray-500">Base report id: 1001</div>
          </div>
          ...
          <div className="border-b border-gray-200 px-6 py-4">
            <div className="rounded-lg border border-gray-200 bg-white">
              ...
              <div className="flex items-center border-b border-gray-200 px-4 py-3">
                ...
                <div className="ml-6 flex flex-1 items-center space-x-4 text-sm">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1">Eda Scheduler Creation Notification UI</span>
                  </div>
                  <div className="flex items-center">
                    <span className="font-medium">Application Code:</span>
                    <span className="ml-1">KNOVA Platform</span>
                  </div>
                  <div className="flex items-center">
              ...
              <div className="grid grid-cols-4 gap-6 p-4">
                <div>
                  ...
                  <div className="relative">
                    <select className="w-full appearance-none rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                      <option>Eda Scheduler Creation Notification UI</option>
                    </select>
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Application Code</label>
                  <div className="relative">
                    <select className="w-full appearance-none rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                      <option>KNOVA Platform</option>
                      <option>KloudNova Platform</option>
                      <option>KNova Portal</option>
                      <option>KloudNova App</option>
                    </select>
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                      <ChevronDown className="h-4 w-4" />
                    </div>
