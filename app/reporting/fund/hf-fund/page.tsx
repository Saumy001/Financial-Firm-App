        ...
        <div className="flex-1 overflow-auto">
          ...
          <div className="border-b border-gray-200 bg-gray-50 px-6 py-2">
            <div className="flex items-center text-sm text-gray-500">
              ...
              <span className="mx-2">/</span>
              <span className="text-gray-700">Hedge Fund Transactions</span>
            </div>
          </div>

          {/* Report Header */}
          <div className="border-b border-gray-200 px-6 py-4">
            <h1 className="text-2xl font-semibold text-gray-800">Hedge Fund Transactions</h1>
            <div className="mt-1 text-sm text-gray-500">Base report id: 1007</div>
          </div>
          ...
          <div className="border-b border-gray-200 px-6 py-4">
            <div className="rounded-lg border border-gray-200 bg-white">
              ...
              <div className="flex items-center border-b border-gray-200 px-4 py-3">
                ...
                <div className="ml-6 flex flex-1 items-center space-x-4 text-sm">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1">HDFC Flexi Cap Fund</span>
                  </div>
                  <div className="flex items-center">
                    <span className="font-medium">Dynamic Start Date:</span>
                    <span className="ml-1">None</span>
                  </div>
                  <div className="flex items-center">
                    <span className="font-medium">Dynamic End Date:</span>
                    <span className="ml-1">None</span>
                  </div>
                  <div className="flex items-center">
              ...
              <div className="grid grid-cols-4 gap-6 p-4">
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Fund</label>
                  <div className="relative">
                    <select className="w-full appearance-none rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                      ...
                      <option>HDFC Small Cap Fund</option>
                      <option>HDFC Mid Cap Fund</option>
                      <option>HDFC Large Cap Fund</option>
                    </select>
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Dynamic Start Date</label>
                  <div className="relative">
                    <select className="w-full appearance-none rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                    <option>None</option>
                      <option>Today</option>
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Dynamic End Date</label>
                  <div className="relative">
                    <select className="w-full appearance-none rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-gray-700 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                    <option>None</option>
                      <option>Today</option>
