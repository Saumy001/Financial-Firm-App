          ...
          <div className="border-b border-gray-200 px-6 py-4">
            <div className="rounded-lg border border-gray-200 bg-white">
              ...
              <div className="flex items-center border-b border-gray-200 px-4 py-3">
                ...
                <button className="ml-auto flex items-center rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700" onClick={()=> router.push("/reporting/fund/income-statement/result") }>
              ...
              <div className="flex border-t border-gray-200 p-4">
                ...
                <button className="ml-3 f  lex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
